...
-(void)addControls
{
   ...
   //顶部View
    ...
    scoreName.frame=CGRectMake(0, topViewY+topViewH+20, SCREEN_WIDTH, 20);
    scoreName.textColor=[UIColor whiteColor];
    scoreName.text=@"平均杆数";
    scoreName.font=[UIFont systemFontOfSize:20];
    scoreName.textAlignment=NSTextAlignmentCenter;
    scoreName.textColor=ZCColor(85, 85, 85);
    [self.scrollView addSubview:scoreName];
    ...
    CGFloat middleViewY=scoreName.frame.size.height+scoreName.frame.origin.y+10;
   ...
   // (middleView.frame.size.height-10)/2+5
    UILabel *scoreNumber=[[UILabel alloc] init];
    scoreNumber.frame=CGRectMake((middleView.frame.size.width-20)/2, (middleView.frame.size.height-10)/2-1, 20, 15);
    ...
    scoreNumber.font=[UIFont systemFontOfSize:15];
...
-(void)bottomviewControls:(UIView *)bottomView
{
    ...
    [self addChildControls:firstView imageStr:@"xintianweng" numberStr:[NSString stringWithFormat:@"%@",self.homePageStatistics.double_eagle] nameStr:@"信天翁"];
    ...
    [self addChildControls:secendView imageStr:@"laoying" numberStr:[NSString stringWithFormat:@"%@",self.homePageStatistics.eagle] nameStr:@"老鹰"];
    ...
    [self addChildControls:thirdView imageStr:@"xiaoniao" numberStr:[NSString stringWithFormat:@"%@",self.homePageStatistics.birdie] nameStr:@"小鸟"];
    
    
    UIView *fourthView=[[UIView alloc] init];
    
    CGFloat fourthViewX=bottomView.frame.size.width/2;
    ...
    [self addChildControls:fourthView imageStr:@"shuangbiji" numberStr:[NSString stringWithFormat:@"%@",self.homePageStatistics.double_bogey] nameStr:@"双柏忌+"];
    ...
    [self addChildControls:fifthView imageStr:@"biaozhungan" numberStr:[NSString stringWithFormat:@"%@",self.homePageStatistics.par] nameStr:@"标准"];
    ...
    [self addChildControls:sixthView imageStr:@"boji" numberStr:[NSString stringWithFormat:@"%@",self.homePageStatistics.bogey] nameStr:@"柏忌"];
