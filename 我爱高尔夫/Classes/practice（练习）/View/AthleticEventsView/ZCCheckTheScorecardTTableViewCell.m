//
//  ZCCheckTheScorecardTTableViewCell.m
//  我爱高尔夫
//
...
@interface ZCCheckTheScorecardTTableViewCell()
...
@implementation ZCCheckTheScorecardTTableViewCell
...
{
    static NSString *ID = @"ZCCheckTheScorecardTTableViewCell";
    ZCCheckTheScorecardTTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:ID];
    if (cell == nil) {
        cell = [[ZCCheckTheScorecardTTableViewCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:ID];
    }
    return  cell;
}
